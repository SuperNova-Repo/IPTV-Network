...
required_modules = ['multidict', 'requests', 'tqdm', 'aiohttp']
...
def check_and_install_module(module_name):
    try:
        ...
        try:
            ...
            print(f"{module_name} wurde aktualisiert.\n\n\n")
        except subprocess.CalledProcessError:
            print(f"Fehler beim Aktualisieren von {module_name}. Die vorhandene Version wird verwendet.\n\n\n")
    except ImportError:
        print(f"{module_name} wird installiert...")
        try:
            subprocess.check_call([sys.executable, "-m", "pip", "install", module_name])
            print(f"{module_name} wurde erfolgreich installiert.\n\n\n")
        except subprocess.CalledProcessError:
            print(f"Fehler beim Installieren von {module_name}. Bitte installieren Sie es manuell.\n\n\n")

# Überprüfen, installieren und aktualisieren der benötigten Module
